...
- Resource Allocation, Supply Network Optimization and GTM Lab CTAs resolve to working Observatory applications.
- Canonical public demo names remain unchanged across locales: `Resource Allocation`, `Supply Network Optimization`, `GTM Lab`.
