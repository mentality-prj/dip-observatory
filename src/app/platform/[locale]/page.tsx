...
export async function generateMetadata({params}:{params:Promise<{locale:string}>}):Promise<Metadata>{const{locale}=await params;if(!isMarketingLocale(locale))return{};const v=metadataByLocale[locale];return{title:{absolute:v.title},description:v.description,alternates:{canonical:`https://qdip.ai/${locale}`,languages:{en:"https://qdip.ai/en",uk:"https://qdip.ai/uk",pl:"https://qdip.ai/pl"}},openGraph:{title:v.title,description:v.description,url:`https://qdip.ai/${locale}`,siteName:"QDIP",type:"website"}}}
