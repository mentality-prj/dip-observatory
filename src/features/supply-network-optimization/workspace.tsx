...
const copy = {
  en: {
    ...
    scenarioComparison: 'Before and after the disruption',
  ...
  pl: {
    ...
    reallocated: 'Zaktualizowana sieć',
    ...
    scenarioComparison: 'Przed i po zakłóceniu',
