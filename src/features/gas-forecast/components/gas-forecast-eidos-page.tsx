        ...
        <header className="space-y-3">
          ...
          <div className="space-y-1">
            ...
            <p className="max-w-3xl text-sm text-slate-400">
              Evaluate how required gas volume could be secured under uncertainty. Commercial value remains unvalidated
              until the frozen-dataset economic gate passes.
            </p>
          </div>
        </header>

        <GasProcurementDecisionDemo
          volumeMwh={form.volume_mwh}
          deadline={form.end_date}
          horizonDays={form.forecast_horizon_days}
        />
            ...
            >
              <div className="grid gap-3 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="start-date">Historical start</Label>
                  <Input
                    id="start-date"
                    type="date"
                ...
                <div className="space-y-2">
                  <Label htmlFor="end-date">Procurement deadline</Label>
                  <Input
                    id="end-date"
                    type="date"
                    className="h-11 min-h-11 max-h-11 appearance-none"
                ...
                <div className="space-y-2">
                  <Label htmlFor="forecast-horizon-days">Decision horizon, days</Label>
                  <Input
                ...
                <div className="space-y-2">
                  <Label htmlFor="volume-mwh">Required volume, MWh</Label>
                  <Input
                    id="volume-mwh"
                    type="number"
                    min={1}
                ...
                <div className="space-y-2 md:col-span-2">
                  <Label htmlFor="procurement-threshold">Legacy research threshold, €/MWh</Label>
                  <Input
              ...
              <Button type="submit" size="lg" className="w-full" disabled={isPending}>
                {isPending ? 'Running research evaluation...' : 'Run research evaluation'}
              </Button>
            </form>
          </CardContent>
        </Card>
        ...
        {result ? (
          <Card>
            <CardHeader className="space-y-4">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <CardTitle>Technical execution</CardTitle>
            ...
            <CardContent className="space-y-4">
              ...
              <details className="border-t border-white/10 pt-3">
                ...
                <pre
                  ...
                  className="mt-2 overflow-x-auto rounded-[var(--ds-radius-panel)] border border-white/8 bg-black/20 p-3 text-xs text-slate-200"
                >
