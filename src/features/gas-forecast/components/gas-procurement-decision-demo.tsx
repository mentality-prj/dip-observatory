    ...
    <Card aria-label="Procurement decision overview">
      ...
      <CardContent className="space-y-5">
        ...
        <div className="rounded-2xl border border-amber-300/20 bg-amber-300/[0.06] p-4">
          ...
          <p className="mt-1 text-sm text-slate-300">QDIP has not yet passed the real frozen-dataset economic validation gate. No savings claim or buy/defer allocation is shown until that evidence exists.</p>
        </div>
        ...
        <div className="grid gap-3 md:grid-cols-3">
          ...
          <div className="rounded-2xl border border-white/8 p-4">
            ...
            <p className="mt-2 text-sm text-slate-200">Compared with a named procurement baseline in €/MWh and total €.</p>
          </div>
          <div className="rounded-2xl border border-white/8 p-4">
            <p className="text-xs font-semibold uppercase tracking-[0.16em] text-slate-500">Risk & uncertainty</p>
            <p className="mt-2 text-sm text-slate-200">Downside and uncertainty will be shown separately from the recommendation.</p>
          </div>
        </div>

        <p className="text-xs text-slate-500">Research protocol, dataset identity and statistical diagnostics remain available below as audit evidence.</p>
      </CardContent>
    </Card>
  )
}
