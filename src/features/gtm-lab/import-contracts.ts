...
const opportunitySchema = z.object({
  ...
  expected_contract_value_eur: z.number().nullable().optional(),
  expected_acquisition_cost_eur: z.number().nullable().optional(),
  expected_implementation_cost_eur: z.number().nullable().optional(),
...
const decisionSchema = z.object({
  ...
  provenance: z
    .object({
      ...
      executed_at: z.string().default(''),
      plugin_id: z.string().default('gtm-lab'),
