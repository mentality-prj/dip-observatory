...
test('today is accepted', () => {
  assert.equal(validateEntsogHistoricalDateRange({ from: '2026-09-05', to: '2026-09-05' }, '2026-09-05'), null)
})

test('yesterday is accepted', () => {
  assert.equal(validateEntsogHistoricalDateRange({ from: '2026-09-04', to: '2026-09-04' }, '2026-09-05'), null)
})

test('tomorrow is rejected', () => {
  assert.equal(
    validateEntsogHistoricalDateRange({ from: '2026-09-06', to: '2026-09-06' }, '2026-09-05'),
...
test('from=yesterday and to=today is accepted', () => {
  assert.equal(validateEntsogHistoricalDateRange({ from: '2026-09-04', to: '2026-09-05' }, '2026-09-05'), null)
})

test('from=today and to=yesterday is rejected', () => {
  assert.equal(
    validateEntsogHistoricalDateRange({ from: '2026-09-05', to: '2026-09-04' }, '2026-09-05'),
...
test('both future dates are rejected', () => {
  assert.equal(
    validateEntsogHistoricalDateRange({ from: '2026-09-07', to: '2026-09-08' }, '2026-09-05'),
    'Future dates are not available.'
  )
})
...
test('manual future-date input is rejected', () => {
  assert.equal(
    validateEntsogHistoricalDateRange({ from: '2026-09-05', to: '2026-09-06' }, '2026-09-05'),
    'Future dates are not available.'
  )
})
...
test('invalid/impossible ISO dates are rejected', () => {
  assert.equal(
    validateEntsogHistoricalDateRange({ from: '2026-02-30', to: '2026-09-05' }, '2026-09-05'),
    'Invalid date.'
  )
  assert.equal(
    validateEntsogHistoricalDateRange({ from: '2026-09-05', to: '2026-13-01' }, '2026-09-05'),
    'Invalid date.'
  )
})
