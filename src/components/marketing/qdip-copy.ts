...
export const marketingCopy: Record<MarketingLocale, MarketingCopy> = {
  en: {
    ...
    platform: { eyebrow: "One platform, full decision lifecycle", title: "Model. Decide. Observe. Improve.", body: "QDIP keeps authoring, execution and observation connected without collapsing them into one opaque AI workflow.", layers: [
      { label: "QDIP ENGINE", title: "Execute governed decisions", description: "Evaluate rules, models, constraints, uncertainty and alternatives behind one stable API.", bullets: ["Hybrid rule + ML execution", "Risk and uncertainty analysis", "Versioned traces and evidence"] },
    ...
    demos: { eyebrow: "QDIP in action", title: "Live decision demonstrators", body: "Explore domain-specific workspaces with explicit alternatives, uncertainty, constraints and decision evidence—not static mockups.", run: "Run demo", all: "View every demonstrator", items: [
      ...
      { title: "Resource allocation", description: "Allocate mobile teams across demand, skills, capacity, accessibility and travel constraints.", domain: "OPERATIONS" },
  ...
  uk: {
    ...
    eyebrow: "Якісно керований інтелект прийняття рішень",
    ...
    buildStudio: "Створити у Studio", heroProof: "Пояснюваність за задумом · Контроль людини · API-first",
    ...
    trust: { eyebrow: "Для відповідальної автоматизації", title: "Довіра є частиною виконання.", body: "QDIP не просить команди приймати незрозумілий бал. Докази, відповідальність і перевірка залишаються частиною життєвого циклу рішення.", badge: "Пояснюваність і аудит за задумом", capabilities: [
    ...
    cta: { title: "Бачте рішення, а не лише дашборд.", body: "Запустіть живий сценарій, перевірте докази та поставте рекомендацію під сумнів.", observatory: "Відкрити Observatory", studio: "Налаштувати у Studio" },
    footer: "Quality-driven Decision Intelligence Platform.",
  },
  pl: {
    nav: ["Platforma", "Produkty", "Demo", "Zaufanie"],
    openStudio: "Otwórz Studio", exploreDemos: "Zobacz demo",
    eyebrow: "Decision intelligence sterowane jakością",
    ...
    platform: { eyebrow: "Jedna platforma, pełny cykl życia decyzji", title: "Modeluj. Decyduj. Obserwuj. Ulepszaj.", body: "QDIP łączy projektowanie, wykonanie i obserwację, nie zamieniając ich w nieprzejrzysty proces AI.", layers: [
      { label: "QDIP ENGINE", title: "Wykonuj nadzorowane decyzje", description: "Oceniaj reguły, modele, ograniczenia, niepewność i alternatywy poprzez stabilne API.", bullets: ["Hybrydowe wykonanie reguł i ML", "Analiza ryzyka i niepewności", "Wersjonowane ślady i dowody"] },
    ...
    demos: { eyebrow: "QDIP w działaniu", title: "Interaktywne demonstratory decyzji", body: "Poznaj branżowe środowiska z jawnymi alternatywami, niepewnością, ograniczeniami i dowodami — nie statyczne makiety.", run: "Uruchom demo", all: "Zobacz wszystkie demonstratory", items: [
      ...
      { title: "Wybór dostawcy", description: "Porównuj dostawców według kosztu, odporności, niepewności i ograniczeń operacyjnych.", domain: "ŁAŃCUCH DOSTAW" },
      ...
      { title: "Laboratorium rdzenia decyzyjnego", description: "Uruchamiaj scenariusze referencyjne przez stan, alternatywy, ryzyko, niepewność i dowody.", domain: "PLATFORMA" },
    ] },
    trust: { eyebrow: "Dla odpowiedzialnej automatyzacji", title: "Zaufanie jest częścią wykonania.", body: "QDIP nie wymaga akceptowania niewyjaśnionej oceny. Dowody, odpowiedzialność i przegląd pozostają częścią cyklu życia decyzji.", badge: "Wyjaśnialność i audyt od podstaw", capabilities: [
      ...
      { title: "Granice tenantów", description: "Ograniczaj klucze API, profile i zapisy audytu do organizacji, która jest ich właścicielem." },
    ] },
