...
export function MarketingHeader({
  ...
  const mobileItems = [
    ...items,
    { href: observatoryHref('', locale), label: 'Observatory' },
    { href: studioHref('', locale), label: 'Studio' },
  ]
  ...
  return (
    <header className={styles.header}>
      <div className={styles.headerInner}>
        <Link className={styles.brand} href={marketingLocaleHref(locale)} aria-label="QDIP home">
          <QdipLogo />
        </Link>
