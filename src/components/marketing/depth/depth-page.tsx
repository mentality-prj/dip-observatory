...
export function DepthPage({locale,page}:{locale:MarketingLocale;page:DepthPageKey}){
 ...
 return <DesignSystemProvider theme="burgundy" mode="light" className={styles.page}><main id="main-content">
